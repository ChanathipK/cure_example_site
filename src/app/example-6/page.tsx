            ...
            <div className="max-w-screen-xl mx-auto min-h-screen max-h-[150vh] pt-36 bg-blue-200">
                <div className="h-96 bg-blue-300 p-4">
                    <div className="flex gap-2">
                        ...
                        <p className="px-4 py-2 bg-white rounded-md">This button shows screen size. Screen size is the resolution of the screen. It's not affected by zoom but affected by scaling.</p>
                    </div>
